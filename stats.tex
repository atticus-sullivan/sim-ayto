...
\begin{tikzpicture}
	\begin{axis}[
		...
		\input{statsMN.tex.sort}
		\addplot[ending] coordinates {(10,0) (10,25)};
	\end{axis}
\end{tikzpicture}
\begin{tikzpicture}
	\begin{axis}[
...
\begin{tikzpicture}
	\begin{axis}[
		...
		\input{statsInfo.tex.sort}
		\addplot[ending] coordinates {(20,0) (20,27)};
		\addplot[ending] coordinates {(0,3.3219280948874) (25,3.3219280948874)};
	\end{axis}
\end{tikzpicture}
