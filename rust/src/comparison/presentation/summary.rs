...
///
/// - `cmp_data` is pairs of `(ruleset_name, [crate::comparison::data::CmpData])`
/// - `lang` controls the i18n labels (e.g. [`crate::comparison::Language::De`] /
///   [`crate::comparison::Language::En`]).
///
